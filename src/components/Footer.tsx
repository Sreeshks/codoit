      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-300 mt-4">
              Empowering businesses to achieve their digital transformation goals with innovative solutions.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/services" className="text-gray-300 hover:text-white transition-colors">Mobile Apps</Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-3">
                <svg className="w-5 h-5 mt-1 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-gray-700 mt-10 pt-6">
          <p className="text-gray-300 text-center">
            © {currentYear} Co Do It. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
